...
int main(void)
{
	struct s_node *root1, *monkey1;

	fprintf(stderr, "====================[TEST 1]====================\n");
	root1 = genMaxHeap((unsigned)time(NULL)+(unsigned)clock()); //get a max heap
	...
	monkey1 = randomMonkey();
	fprintf(stderr, "inserting random monkey1(%d)...\n", monkey1->value);
	insertMonkey(&root1, monkey1);
	printBinaryTree(root1);
	...
	root2->right = b(3);
	root2->left->left = b(2);
	root2->left->right = b(4);
	printBinaryTree(root2);
	fprintf(stderr, "inserting monkey2(%d)...\n", monkey2->value);
	insertMonkey(&root2, monkey2);
	printBinaryTree(root2);

	struct s_node *root3, *monkey3;
	...
	root3->right = b(3);
	root3->left->left = b(2);
	root3->left->right = b(4);
	printBinaryTree(root3);
	fprintf(stderr, "inserting monkey3(%d)...\n", monkey3->value);
	insertMonkey(&root3, monkey3);
	printBinaryTree(root3);
#endif
